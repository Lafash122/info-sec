...
Суть исправления заключается в том, чтобы показывать пользователю описательную информацию о возникшей проблеме. То есть вместо вывода стектрейса, можно, например, вывести "Проблема при обращении к СУБД".
